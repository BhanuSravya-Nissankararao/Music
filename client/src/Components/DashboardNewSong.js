...
export default function DashboardNewSong() {
 ...
 return (
    <div className='flex flex-col items-center justify-center p-4 border border-gray-300 gap-4 rounded-md'>
        <input type="text" placeholder="type your song same..." className="w-full p-3 rounded-md text-base font-semibold text-textColor 
                ...
                <>
                    {!songImageCover ?(
                        ...
                        <div className="relative w-full h-full overflow-hidden rounded-md">
                            ...
                            outline-none border-none hover:shadow-md duration-200 transition-all ease-in-out"
                ...
                <>
                    {!audioImageCover ?(
                        ...
                        <div className="relative w-full h-full flex items-center justify-center overflow-hidden rounded-md">
                            {/* <audio src={audioImageCover} className="w-full h-full object-cover" alt="" /> */}
        ...
        <div className="flex items-center justify-center w-24 p-4 cursor-pointer">
        ...
        <div className="bg-card backdrop-blur-md w-full h-300 rounded-md border-2 border-dotted border-gray-300 cursor-pointer">
            ...
            {!isArtistUploading && (
                <>
                    {!artistImageCover ?(
                        <FileUploader updateState={setArtistImageCover} setProgress={setArtistUploadingProgress} 
        ...
        {/* artist name */}
        <input type="text" placeholder="Artist Name..." className="w-full p-3 rounded-md text-base font-semibold text-textColor 
        outline-none shadow-sm border border-gray-300 bg-transparent" 
        ...
        <div className="flex items-center rounded-md shadow-sm border border-gray-300 w-full">
            <p className="text-base font-semibold p-0 text-gray-400">www.twitter.com/</p>
        ...
        {/* instagram */}
        <div className="flex items-center rounded-md shadow-sm border border-gray-300 w-full">
            <p className="text-base font-semibold p-0 text-gray-400">www.instagram.com/</p>
        ...
        <div className="bg-card backdrop-blur-md w-full h-300 rounded-md border-2 border-dotted border-gray-300 cursor-pointer">
            ...
            {!isAlbumUploading && (
                <>
                    {!albumImageCover ?(
                        <FileUploader updateState={setAlbumImageCover} setProgress={setAlbumUploadingProgress} 
        ...
        {/* album name */}
        <input type="text" placeholder="Album Name..." className="w-full p-3 rounded-md text-base font-semibold text-textColor 
        outline-none shadow-sm border border-gray-300 bg-transparent" 
...
export const DisabledButton = () => {
    return (
      <button
        ...
        text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex 
        items-center"
      >
        <svg
          role="status"
        ...
        >
          <path
            ...
            91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 
          ...
          <path
            ...
            51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 
...
export const FileUploader = ({updateState,setProgress,isLoading,isImage}) => {
    ...
    return(
        <label>
            ...
            <input type="file" name="upload-file" accept={`${isImage ? "image/*" : "auido/*"}`} 
